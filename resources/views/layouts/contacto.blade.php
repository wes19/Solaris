...
<body class="bg-gray-100 font-sans text-gray-900">
    <div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md mt-8">
        ...
        <p class="text-base text-gray-700 mb-4">
            <strong class="text-red-600 font-semibold">País:</strong> {{ $messageContact['pais'] }} <br>
        ...
        <p class="text-base text-gray-700 mb-4">
            <strong class="text-red-600 font-semibold">Descripción de la consulta:</strong> {{ $messageContact['mensaje'] }}
        </p>
