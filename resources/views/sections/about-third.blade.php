<div class="h-[100vh] bg-[#000F33] flex xl:flex-row flex-col px-12 gap-8">
    ...
    <div class="flex mb-10 w-full flex-col pt-12 text-white">
        ...
        <p class="xl:min-w-[244px] md:w-[95%] w-full font-medium tracking-tighter xl:text-2xl lg:text-xl text-lg md:text-justify mt-20 text-left">
